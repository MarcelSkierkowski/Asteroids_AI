...
SMALL_ASTEROID = pygame.transform.scale(pygame.image.load(os.path.join(os.getcwd(), "game_objects", "PICS", "asteroid1.png")),
                                        (int(WIDTH / 20), int(HEIGHT / 20)))
MEDIUM_ASTEROID = pygame.transform.scale(pygame.image.load(os.path.join(os.getcwd(), "game_objects", "PICS", "asteroid2.png")),
                                         (int(WIDTH / 11), int(HEIGHT / 11)))
HUGE_ASTEROID = pygame.transform.scale(pygame.image.load(os.path.join(os.getcwd(), "game_objects", "PICS", "asteroid3.png")),
